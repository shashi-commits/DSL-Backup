...
export default function InteractiveMap() {
  ...
  const MapComponent = useMemo(() => dynamic(
    ...
    {
      loading: () => (
        // Show a responsive loading placeholder while the map loads
        <div className="flex h-[45vh] sm:h-[55vh] w-full items-center justify-center rounded-3xl bg-gray-100">
