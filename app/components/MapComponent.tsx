...
// NEW: Function to create custom, color-coded icons
const getCategoryIcon = (category: string) => {
  const color = getCategoryColor(category);
  // Using an SVG path for a map pin
  const iconHtml = `<svg viewBox="0 0 24 24" width="32" height="32" xmlns="http://www.w3.org/2000/svg" style="transform: translate(0, 4px);">
  ...
  return L.divIcon({
    html: iconHtml,
    className: 'custom-map-icon', // Use this CSS class
    iconSize: [32, 40],
